...
class Simulator:
    ...
    def __init__(self, topology):
        ...
        self._attach_metrics_collector()

    def _attach_metrics_collector(self):
        for node in self.topology.nodes.values():
            if hasattr(node, "attach_metrics_collector"):
                node.attach_metrics_collector(self.metrics)

    def reset_metrics(self):
        """Clear tracked metrics without disturbing topology state."""
        self.metrics.reset()
    ...
    def _mark_packet_injected(self, packet):
        ...
        self.metrics.record_injection(packet, self.global_clock)

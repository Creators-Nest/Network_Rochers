...
Manages the main simulation loop and state for mesh network
...
class Simulator:
    """
    Manages the main simulation loop and state for mesh topology.
    Works with EnhancedMeshTopology and EnhancedNode architecture.
